...
<div class="grid grid-cols-1 lg:grid-cols-3">
              ...
              <div class="relative overflow-hidden bg-gradient-to-b bg-orange-400 py-10 px-6 sm:px-10 xl:p-12">
                ...
                <h3 class="text-lg font-medium text-violet-600">information de contact</h3>
                <p class="mt-6 max-w-3xl text-base text-violet-600">Nullam risus blandit ac aliquam justo ipsum. Quam mauris volutpat massa dictumst amet. Sapien tortor lacus arcu.</p>
                <dl class="mt-8 space-y-6">
                  <dt><span class="sr-only">numero de telephone</span></dt>
                  <dd class="flex text-base text-violet-600">
